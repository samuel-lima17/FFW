...
function DashboardRouter() {
  // Estado dinâmico para os dados obtidos da API
  ...
  // Consome a API RESTful do SQLite via HTTP GET
  useEffect(() => {
  ...
  // Timer para o Roteamento Dinâmico
  useEffect(() => {
    if (tempoRestante > 0) {
  ...
  // Exibe tela de carregamento até os dados do SQLite chegarem
  if (carregando) {
    return (
